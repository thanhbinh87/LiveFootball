...
public class Storage {
    ...
    /**
     * Commits the cookies into the RMS. Should be called when the midletr terminates.
     */
    ...
    /**
     * Commits the form data into the RMS. Should be called when the midletr terminates.
     */
