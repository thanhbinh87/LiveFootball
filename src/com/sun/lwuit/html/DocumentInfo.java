...
public class DocumentInfo {
    ...
    /**
     * Returns the expected content type, one of TYPE_HTML or TYPE_IMAGE
     *
     * @return the expected content type, one of TYPE_HTML or TYPE_IMAGE
     */
    ...
    /**
     * Sets this expected content type to be either TYPE_HTML or TYPE_IMAGE.
     ...
     *
     * @param requestType the requestType to set, one of TYPE_HTML or TYPE_IMAGE
     */
     ...
     *
     * @param The request paramters to set, should be as a percentage encoded string
     */
