...
/**
 * This class is a wrapper class for a LWUIT font object, that keeps additional info on teh font as required for HTML rendering by HTMLComponent.<br>
...
class HTMLFont {
    ...
    static private int[] SPECIAL_FONT_TAGS_ID = {
        Element.TAG_EM,    Element.TAG_STRONG,
        Element.TAG_DFN, Element.TAG_CODE,
        Element.TAG_SAMP, Element.TAG_KBD,
        Element.TAG_VAR, Element.TAG_CITE,
        Element.TAG_H1, Element.TAG_H2,
        Element.TAG_H3, Element.TAG_H4,
        Element.TAG_H5, Element.TAG_H6,
    };
    ...
    private boolean isBigCounterpart(HTMLFont font) {
        ...
        return  ((family.equals(font.getFamily())) && (style==font.getStyle()));
    }
    ...
    private boolean isBoldCounterpart(HTMLFont font) {
        ...
        return  ((size==font.getSize()) && (family.equals(font.getFamily())) && (italic==font.isItalic()));
    }
    ...
    private boolean isItalicCounterpart(HTMLFont font) {
        ...
        return  ((size==font.getSize()) && (family.equals(font.getFamily())) && (bold==font.isBold()));
    }
