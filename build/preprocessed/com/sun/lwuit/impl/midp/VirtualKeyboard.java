...
public class VirtualKeyboard extends Dialog {
     ...
     */
    public void setTextField(final TextField field) {
        this.field = field;
        removeAll();
        okPressed = false;
        useSoftKeys = field.isUseSoftkeys();
        ...
        inputField = new TextField() {
            ...
            public void deleteChar() {
                ...
                field.setCursorPosition(getCursorPosition());
            }
            ...
            public void setCursorPosition(int i) {
                ...
                if(field != null && field.getText().length() > i) {
                    field.setCursorPosition(i);
                }
            }
  ...
  /**
    ...
    protected void actionCommand(Command cmd) {
        ...
        switch (cmd.getId()) {
            ...
            case T9:
                ...
                if(field != null){
                    field.setText(inputField.getText());
                    field.setCursorPosition(inputField.getText().length());
                }
                dispose();
                finishedT9Edit = true;
        }
    ...
    public void dispose() {
        if (field != null) {
            ...
            field.setUseSoftkeys(useSoftKeys);
            setTransitionInAnimator(
                    CommonTransitions.createSlide(CommonTransitions.SLIDE_VERTICAL, true, 500));
            field = null;
        }
     ...
     * 
     * @param tf the TextField to bind a VirualKeyboard to.
     * @param vkb the binded VirualKeyboard.
     */
    public static void bindVirtualKeyboard(TextField tf, VirtualKeyboard vkb) {
        tf.putClientProperty(MARKER_VKB, vkb);
    }
     ...
     * 
     * @param tf a TextField.that might have an associated VirtualKeyboard instance
     * @return a VirtualKeyboard instance or null if not exists.
     */
    public static VirtualKeyboard getVirtualKeyboard(TextField tf) {
        return (VirtualKeyboard) tf.getClientProperty(MARKER_VKB);
    }
     ...
     */
    public static boolean isCommitOnDispose(TextField tf) {
     ...
     */
    public static int getVKBTint(TextField tf) {
